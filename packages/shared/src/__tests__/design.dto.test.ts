import { DesignSchema } from "../dtos/design.dto";
...
describe("DesignDTO Validator", () => {
    it("validates a correct design payload", () => {
        ...
        const result = DesignSchema.safeParse(validPayload);
    ...
    it("rejects payload with invalid dimensions", () => {
        ...
        const result = DesignSchema.safeParse(invalidPayload);
    ...
    it("applies default values correctly", () => {
        ...
        const result = DesignSchema.safeParse(defaultPayload);
        expect(result.success).toBe(true);
        if (result.success) {
